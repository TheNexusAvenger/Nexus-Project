...
local function Setup()
	...
	return CuT,Folder1,Folder2,Folder3
end
...
NexusUnitTesting:RegisterUnitTest("GetContext",function(UnitTest)
	...
	UnitTest:AssertEquals(CuT.__ExternalDependencies[script],{"Folder1A.Folder1B.ModuleScript1B","Test2.Folder3A.ModuleScript3A"},"External dependencies is incorrect.")
end)
...
NexusUnitTesting:RegisterUnitTest("GetResource",function(UnitTest)
	...
	--Run the assertions.
	UnitTest:AssertEquals(CuT:GetResource(""),Folder1,"Path returned incorrectly.")
	UnitTest:AssertEquals(CuT:GetResource("ModuleScript1A"),"Test 1","Path returned incorrectly.")
	UnitTest:AssertEquals(CuT:GetResource("Folder1A"),Folder1.Folder1A,"Path returned incorrectly.")
	UnitTest:AssertEquals(CuT:GetResource("Folder1A.Folder1B"),Folder1.Folder1A.Folder1B,"Path returned incorrectly.")
	UnitTest:AssertEquals(CuT:GetResource("Folder1A.Folder1B.ModuleScript1B"),"Test 2","Path returned incorrectly.")
	UnitTest:AssertEquals(CuT:GetResource("Test1"),Folder2,"Path returned incorrectly.")
	UnitTest:AssertEquals(CuT:GetResource("Test1.ModuleScript2A"),"Test 3","Path returned incorrectly.")
	UnitTest:AssertEquals(CuT:GetResource("Test2"),Folder3,"Path returned incorrectly.")
	UnitTest:AssertEquals(CuT:GetResource("Test2.Folder3A"),Folder3.Folder3A,"Path returned incorrectly.")
